...
export function CustomTable() {
  ...
  return (
    ...
    <div id='homeBottomDivRightDiv' >
  <div id='tableHeader'>
  <h5 >Supplier-wise
                  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="19"  viewBox="1 -1 21 19" fill="none">
                ...
                <button ><svg xmlns="http://www.w3.org/2000/svg" width="10" height="13" viewBox="0 0 10 13" fill="none">
       ...
       <thead id = 'tableHeading'>
        ...
        <tbody>
            {
                tabledata.filter((e) => e.year == '2023').map((e) => {
                 return <tr>
                 <td>{e.month}</td>
                  <td>{e.emissions}</td>
                  <td>{e.r_e}</td>  
                  <td style={{ color: tabledatacolor(e.yoy_r_e_change).color }}>
                  {e.yoy_r_e_change} {tabledatacolor(e.yoy_r_e_change).content}
                   </td>
               </tr>
               })
             }
